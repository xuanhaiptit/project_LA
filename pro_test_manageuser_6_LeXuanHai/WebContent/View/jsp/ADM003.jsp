...
<body>
	...
	<!-- Begin vung input-->
	<form
		action="AddUserInput.do?type=validateUser&edit=${edit}&userId=${userInfo.id}"
							...
							<tr>
								...
								<td align="left"><select name="groupId">
										...
										<c:forEach items="${listGroup}" var="list">
											<option
												${list.groupId == userInfo.group ? 'selected = "selected"' : ''}
								...
								<td align="left"><select name="codeLevel">
										...
										<c:forEach items="${listJapan}" var="listJapan">
											<option
												...
												value="${listJapan.codeLevel}">${listJapan.codeLevel}</option>
										</c:forEach>
								</select></td>
							</tr>
							<tr>
