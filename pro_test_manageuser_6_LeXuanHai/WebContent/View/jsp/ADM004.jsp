...
<body>
	...
	<!-- Begin vung input-->
	<form action="AddUserConfirm.do?type=${edit}" method="post"
		name="inputform">
					...
					<div style="display: none; margin-left: 100px" id="tableLvelJapan">
						<table border="1" width="70%" class="tbl_input" cellpadding="4"
							...
							<tr>
								...
								<td align="left"><c:if
										test="${!userInfo.codeLevel.equals('0')}">
			...
			<table border="0" cellpadding="4" cellspacing="0" width="300px">
				<tr>
					...
					<td><input class="btn" type="button" value="戻る"
						onclick="javascript:window.location.href='AddUserInput.do?type=back&key='+${key};" /></td>
				</tr>
			</table>
		</div>
		<!-- End vung button -->
